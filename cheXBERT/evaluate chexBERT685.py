...
# Load files
pred_df = pd.read_excel(r"C:\Users\Dell\Desktop\chexBERT_labels685.xlsx")
...
results_df.to_excel(r"C:\Users\Dell\Desktop\chexbert_evaluation_results685.xlsx", index=False)
merged.to_excel(r"C:\Users\Dell\Desktop\chexbert_vs_groundtruth_685.xlsx", index=False)

print("\nSaved: chexbert_evaluation_results685.xlsx")